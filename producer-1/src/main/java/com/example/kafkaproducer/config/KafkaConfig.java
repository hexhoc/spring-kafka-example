...
public class KafkaConfig {
    ...
    // Autowired. Get data from application.yaml (prefix = "spring.kafka")
...
//        var pf = new DefaultKafkaProducerFactory<String, String>(producerConfigs());
//        pf.transactionCapable();
//        pf.setTransactionIdPrefix(kafkaProperties.getProducer().getTransactionIdPrefix());
//        return pf;
//    }
//
//
